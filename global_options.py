...
# Hardware options
N_CORES: int = 1  # max number of CPU cores to use
RAM_CORENLP: str = "16G"  # max RAM allocated for parsing using CoreNLP

# Directory locations
os.environ[
    "CORENLP_HOME"
] = "/Users/eklavya/WORK_RAJ/BOOTH/Text_Analysis_OLD/stanford-corenlp-full-2018-10-05/"  # location of the CoreNLP models
